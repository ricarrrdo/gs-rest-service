...
* PROBLEM: still getting {"errors":[{"code":215,"message":"Bad Authentication data."}]} from Twitter when trying to send a direct message
 * */
...
public class Application {
    ...
    //to make it easier (taken from Twitter example: https://developer.twitter.com/en/docs/basics/authentication/guides/creating-a-signature.html):
    ...
    public static void sendMessageTwitter(String msg, String recipient){
        ...
        HttpHeaders httpHeaders = createOAuthHeader("POST", url, msg); //msg might not be needed here
        ...
        restASyncClientBody(HttpMethod.POST, url, httpHeaders, bodyContent, deferredResult);
    ...
    public static HttpHeaders createOAuthHeader(String httpMethod, String url, String text) {
        ...
        String epochA = "1318622958";

        String nonce = generateNonce();
        String nonceA = "kYjzVBB8Y0ZFabxSWbWovY3uYSQ2pTgmZeNu2VS4cg";
        ...
        ///uncomment next line and signature will be "hCtSmYh+iHYCEqBWrE7C7hYmtUk=", just like in Twitter given example
        //String baseString = "POST&https%3A%2F%2Fapi.twitter.com%2F1.1%2Fstatuses%2Fupdate.json&include_entities%3Dtrue%26oauth_consumer_key%3Dxvz1evFS4wEEPTGEFPHBog%26oauth_nonce%3DkYjzVBB8Y0ZFabxSWbWovY3uYSQ2pTgmZeNu2VS4cg%26oauth_signature_method%3DHMAC-SHA1%26oauth_timestamp%3D1318622958%26oauth_token%3D370773112-GmHxMAgYyLbNEtIKZeRNFsMKPR9EyMZeS9weJAEb%26oauth_version%3D1.0%26status%3DHello%2520Ladies%2520%252B%2520Gentlemen%252C%2520a%2520signed%2520OAuth%2520request%2521";
    ...
    public static String createOAuthBaseString(String httpMethod, String url, String parameterString) {
        ...
        //debug
        //System.out.println(">>>>>baseString: " + sb.toString());
    ...
    public static String createSignatureBase64(String baseString, String signingKey) {
        ...
        System.out.println(">>>>>>>>>signature_Base64: " + signatureBase64);
